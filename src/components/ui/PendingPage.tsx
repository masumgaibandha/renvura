 ...
 * safety wording. Every page rendered through this is `noindex, nofollow` and
 * is excluded from the sitemap (see `src/lib/site.ts`).
 */
    ...
    <Container className="py-12 sm:py-16">
      <div className="max-w-2xl">
        ...
        <div className="mt-8 rounded-2xl border border-line bg-surface p-6">
          ...
          <p className="mt-3 text-sm text-ink-muted">{pendingBody}</p>
          <AppLink
            href="/contact"
